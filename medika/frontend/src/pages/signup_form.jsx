      ...
      <div className="bg-white min-h-screen">
        ...
        >
          <div style={{ marginBottom: "10px" }} className="flex flex-col">
            <label className="text-sm font-Satoshi" htmlFor="firstname">
              Prénom
            </label>
            <input
              name="firstname"
          ...
          <div style={{ marginBottom: "10px" }} className="flex flex-col">
            <label className="text-sm font-Satoshi" htmlFor="lastname">
              Nom
            </label>
            <input
              name="lastname"
          ...
          {errorApi && (
            <Typography
              tag={"p"}
              variant="accentuary"
              customClasses={"pb-2 lg:text-base"}
            >
              <i className="fa-solid fa-triangle-exclamation"></i> {errorApi}
            </Typography>
          )}
          <div style={{ marginBottom: "10px" }} className="flex flex-col">
